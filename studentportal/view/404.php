...
<!-- Mirrored from vuelayout.com/efnify/html/404 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Nov 2018 15:19:56 GMT -->
...
<head>
    ...
    <!--Page title-->
    <title>Page not found! - Efnify</title>
                    ...
                    <div class="nav-wrapper">
                        ...
                        <div class="ui-app__wrapper__navbar__rightside--icons right">
                            ...
                            <div id="dropdown-notifications-target" class="ui-app__wrapper__navbar__rightside--notifications__dropdown dropdown-content">
                                <ul class="collection">
                                    <li class="collection-item avatar"> <img src="<?php echo imgPATH; ?>user1.jpg" alt="user profile picture" class="circle"> <span class="title">Brunch this weekend?</span>
                                        <p>Ali Connors <span class="body-1">&mdash; I'll be in your neighborhood doing errands this weekend.</span></p>
                                    </li>
                                    <li class="collection-item avatar"> <img src="<?php echo imgPATH; ?>user2.jpg" alt="user profile picture" class="circle"> <span class="title">Oui oui</span>
                                        <p>Sandra Adams <span class="body-1">&mdash; Do you have Paris recommendations? Have you ever been?</span></p>
                                    </li>
                                    <li class="collection-item avatar"> <img src="<?php echo imgPATH; ?>user3.jpg" alt="user profile picture" class="circle"> <span class="title">Birthday gift</span>
                                        <p>Trevor Hansen <span class="body-1">&mdash; Have any ideas about what we should get Heidi for her birthday?</span></p>
                                    </li>
                                    <li class="collection-item avatar"> <img src="<?php echo imgPATH; ?>user4.jpg" alt="user profile picture" class="circle"> <span class="title">Recipe to try</span>
                    ...
                    <div class="col s12">
                        <div class="card ui-app__page-content">
                            <div class="card-content">
                                ...
                                <div class="card-title headline center-align">Page not found!</div>


                                <div class="card-body center-align card-body-error">

                                    <div class="title">Sorry, but the page you were looking for could not be found.</div>
