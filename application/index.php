        ...
        <div class="row">
            <div class="col-lg-5">
                <div id="left_form">
                    ...
                    <h2>Application</h2>
                    <p>For a successful school application, you first need to understand each school’s admission
                        requirements, gather information, meet deadlines, and pay any necessary fees.</p>
                    <a href="#0" id="more_info" data-toggle="modal" data-target="#more-info"><i class="pe-7s-info"></i>
                        How to apply</a>
