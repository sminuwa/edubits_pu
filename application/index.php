...
<!--
	<header>
		<div class="container-fluid">
		    <div class="row">
                <div class="col-3">
                    <div id="logo_home">
                        <h1><a href="index.php">MAVIA | Register, Reservation, Questionare, Reviews form wizard</a></h1>
                    </div>
                </div>
                <div class="col-9">
                    <div id="social">
                    ...
                    <nav>
                        <ul class="cd-primary-nav">
                            <li><a href="index.php" class="animated_link">Register Version</a></li>
			...
			<div class="row">
				<div class="col-lg-5">
					<div id="left_form">
						...
						<h2>Application</h2>
						<p>For a successful school application, you first need to understand each school’s admission requirements, gather information, meet deadlines, and pay any necessary fees.</p>
						<a href="#0" id="more_info" data-toggle="modal" data-target="#more-info"><i class="pe-7s-info"></i> How to apply</a>
                        <div class="apply-footer-logo">
                            <a href="../index.php">
	...
	<div class="modal fade" id="more-info" tabindex="-1" role="dialog" aria-labelledby="more-infoLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="more-infoLabel">How to apply</h4>
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				</div>
				<div class="modal-body">
					<p>Some Instruction goes here :)</p>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn_1" data-dismiss="modal">Close</button>
				</div>
