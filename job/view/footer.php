<div id="footer">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-3 col-md-12">
                    <h3><i class="icon-feather-mail"></i> Add you e-Mail For a Newsletter</h3>
                    <p>We'll notify you once there is new opportunity.</p>
    ...
    <div class="footer-bottom-section">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    © 2018 <strong><?php echo $client->name; ?></strong>. All Rights Reserved.
                </div>
            </div>
        </div>
    </div>
