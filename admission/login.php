		...
		<aside>
			<figure>
			  ...
			  <form>
				...
				<a href="#0" class="btn_1 rounded full-width add_top_60">Login to EduBits</a>
				<div class="text-center add_top_10">New to EduBits? <strong><a href="register.php">Sign up!</a></strong></div>
			</form>
			<div class="copy">© <?php echo date("Y"); ?> EduBits</div>
		</aside>
	</div>
	<!-- /login -->
