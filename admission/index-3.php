		...
		<div id="full-slider-wrapper">
			<div id="layerslider" style="width:100%;height:750px;">
				...
				<div class="ls-slide" data-ls="slidedelay: 5000; transition2d:85;">
					...
					<a class="ls-l btn_1 rounded" style="top:65%; left:50%;white-space: nowrap;" data-ls="durationin:2000;delayin:1400;easingin:easeOutElastic;" href='courses-grid.php'>Read more</a>
				</div>
				<!-- second slide -->
				...
				<div class="ls-slide" data-ls="slidedelay: 5000; transition2d:5;">
					...
					<a class="ls-l btn_1 rounded" style="top:65%; left:50%;" data-ls="durationin:2000;delayin:1400;easingin:easeOutElastic;" href='courses-grid.php'>Explore</a>
				</div>
			</div>
		</div>
		<!-- End layerslider -->
