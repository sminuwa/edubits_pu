				...
				<div class="container">
					<div class="bs-wizard clearfix">
						<div class="bs-wizard-step">
							...
							<a href="cart-1.php" class="bs-wizard-dot"></a>
						</div>
				...
				<div class="row">
					...
					<aside class="col-lg-4" id="sidebar">
						<div class="box_detail">
							...
							<a href="cart-3.php" class="btn_1 full-width">Checkout</a>
							<a href="courses-grid-sidebar.php" class="btn_1 full-width outline"><i class="icon-right"></i> Continue Shopping</a>
						</div>
					</aside>
				</div>
				<!-- /row -->
