...
<head>
    ...
    <meta name="description" content="Virtual School Manager">
				...
				<div id="middle-wizard">
					<div class="step">
						<div id="intro">
                            ...
                            <p>Applying to Nursery, Primary or Secondary school means more than just filling out forms.
                                <br>For a successful school application, you first need to understand each school’s
                                admission requirements, gather information, meet deadlines, and pay any necessary fees.
							<br><strong>Plus, each school has different application requirements and deadlines, so it’s important to get organized.</strong></p>
						</div>
					</div>
